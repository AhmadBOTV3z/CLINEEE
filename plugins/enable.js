...
`.trim()
     await conn.send2Button(m.chat, str, watermark, 'Owner', '.owner', 'Menu', '.menu', { key: { fromMe: false, remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { message: `AhmadBOT`, itemCount: 999, thumbnail: fs.readFileSync('./src/RadBotZ.jpg')}}})
}
